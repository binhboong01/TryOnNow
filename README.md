...
## Batch processing Gradio App Deployment

Run the following command to deploy the Gradio App to test the batch processing functionality of the model

```PowerShell
CUDA_VISIBLE_DEVICES=0 python app_dev.py \
