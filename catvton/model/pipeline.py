...
from diffusers import AutoencoderKL, DDIMScheduler, UNet2DConditionModel, BitsAndBytesConfig
...
class CatVTONPipeline:
    def __init__(
        ...
        # self.unet = UNet2DConditionModel.from_pretrained(base_ckpt, quantization_config=quantization_config, subfolder="unet", torch_dtype=weight_dtype)
